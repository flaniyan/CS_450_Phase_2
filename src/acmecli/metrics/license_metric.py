...
class LicenseMetric:
    ...
    def score(self, meta: dict) -> MetricValue:
        ...
        if all_text:
            license_keywords = [
                "license", "licenses", "licensing", "licenced", "licenced",
                "licence", "licences", "licencing", "licenced",
                "copyright", "copyrights", "copyrighted", "copyright notice",
                "terms", "terms of use", "terms of service", "terms and conditions",
                "legal", "legal notice", "legal terms", "legal agreement",
                "licensing terms", "license agreement", "license terms",
                "permission", "permissions", "permitted", "permit",
                "rights", "right", "all rights reserved", "all rights",
                "proprietary", "proprietary license", "proprietary software",
                "open source", "opensource", "open-source", "open source license",
                "free software", "free software license", "free and open source",
                "foss", "f/oss", "free/libre open source software",
                "public domain", "publicdomain", "public-domain",
                "copyleft", "copyleft license", "copyleft software",
                "permissive", "permissive license", "permissive software",
                "commercial", "commercial license", "commercial use",
                "non-commercial", "noncommercial", "non commercial",
                "academic", "academic license", "academic use",
                "research", "research license", "research use",
                "educational", "educational license", "educational use",
            ]
            ...
            readme_compatible = [
                "mit", "mit license", "mit licence", "mit-license", "mit licence",
                "bsd", "bsd license", "bsd licence", "bsd-license", "bsd licence",
                "apache", "apache license", "apache 2.0", "apache 2", "apache-2.0",
                "apache-2", "apache2", "apache2.0", "apache license 2.0",
                "lgpl", "lgpl-2.1", "lgpl 2.1", "lgplv2.1", "lgpl v2.1",
                "lgpl-2", "lgpl 2", "lgplv2", "lgpl v2", "lgpl-3", "lgpl 3",
                "mozilla public license", "mpl", "mpl 2.0", "mpl-2.0", "mpl2.0",
                "gnu lesser general public license", "gnu lgpl", "gnu lgpl v2.1",
                "gpl", "gpl-2", "gpl 2", "gplv2", "gpl v2", "gpl-3", "gpl 3",
                "gplv3", "gpl v3", "gnu general public license", "gnu gpl",
                "agpl", "agpl-3", "agpl 3", "agplv3", "agpl v3",
                "epl", "eclipse public license", "epl-1.0", "epl 1.0",
                "mpl", "mozilla public license", "mpl-2.0", "mpl 2.0",
                "cc0", "cc0 1.0", "cc0-1.0", "creative commons zero",
                "cc-by", "cc by", "creative commons attribution",
                "cc-by-sa", "cc by-sa", "creative commons attribution share-alike",
                "cc-by-nc", "cc by-nc", "creative commons attribution non-commercial",
                "unlicense", "unlicense license", "unlicense-license",
                "isc", "isc license", "isc licence",
                "zlib", "zlib license", "zlib licence",
                "artistic", "artistic license", "artistic licence",
                "python", "python license", "python software foundation license",
                "psf", "psf license", "python software foundation",
            ]
