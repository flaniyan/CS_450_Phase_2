...
class PerformanceClaimsMetric:
    """Metric to assess evidence of performance claims through benchmarks and
    evaluations."""
    ...
    def score(self, meta: dict) -> MetricValue:
        ...
        if readme_text:
            ...
            comparison_keywords = [
                'compared to', 'vs', 'versus', 'outperform', 'better than',
            ...
            eval_datasets = [
                'glue', 'superglue', 'squad', 'coco', 'imagenet', 'wmt',
                'bleu', 'rouge'
            ]
            ...
            paper_keywords = [
                'paper', 'arxiv', 'citation', 'published', 'acl', 'nips',
                'icml', 'iclr', 'emnlp'
            ]
