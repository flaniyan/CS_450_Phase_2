...
class CodeQualityMetric:
    ...
    def score(self, meta: dict) -> MetricValue:
        ...
        if meta.get('pushed_at'):
            ...
            try:
                pushed_date = datetime.fromisoformat(meta['pushed_at'].replace('Z', '+00:00'))
