...
class DatasetAndCodeMetric:
    ...
    def score(self, meta: dict) -> MetricValue:
        ...
        if readme_text:
            ...
            dataset_keywords = [
                'dataset', 'data', 'training data', 'corpus', 'benchmark'
            ]
            ...
            known_datasets = [
                'imagenet', 'coco', 'openimages', 'wikipedia', 'common crawl',
                'glue', 'squad', 'wmt', 'pile', 'c4', 'openwebtext'
            ]
            ...
            code_keywords = [
                'code', 'implementation', 'source', 'repository', 'github', 'script'
            ]
            ...
            example_keywords = [
                'example', 'demo', 'tutorial', 'usage', 'quickstart', 'getting started'
            ]
        ...
        # Check if repository has multiple programming languages
        # (indicates comprehensive codebase)
