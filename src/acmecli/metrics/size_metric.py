...
class SizeMetric:
    ...
    def score(self, meta: dict) -> MetricValue:
        ...
        if readme_text:
            ...
            if any(keyword in readme_text for keyword in ['lightweight', 'small', 'compact', 'efficient']):
            ...
            elif any(keyword in readme_text for keyword in ['large', 'heavy', 'resource-intensive']):
